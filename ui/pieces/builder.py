...
class UIPieceBuilder:
    ...
    def add_mane(self) -> UIPieceBuilder:
        ...
        path = self.scale(
            'path("'
            'm 135.63534,127.03486 '
            'c 4.88867,-22.95693 17.6283,-34.301315 22.47599,-45.241118 21.37925,-48.246605 -8.60704,-77.5078523 '
            '-49.22096,-74.5211696 -2.36366,0.1738201 0.49151,11.1115656 0.49151,11.1115656 37.7491,-4.669007 '
            '53.61883,30.653212 35.9107,63.140057 -17.18396,10.367624 -11.49156,30.051845 -9.65724,45.510665 z")',
            s
        )
    ...
    def add_eye(self):
        ...
        path = self.scale(
            'path("'
            'm 94.152597,36.113755 '
            'c 1.79209,8.351338 -5.312927,11.993216 -10.455928,9.205762 0.511566,-3.785635 7.137462,-9.392004 '
            '10.455928,-9.205762 z")',
            s
        )
    ...
    def add_upper_body(self) -> UIPieceBuilder:
        ...
        path = self.scale(
            'path("'
            'm 71.163998,135.97274 69.082802,0.28245 '
            'c -7.26058,-27.87536 -1.3983,-43.203455 7.54611,-53.594481 '
            'l -16.03137,-8.967442 c -4.10728,4.473023 -9.41986,5.309291 -15.55178,5.743013 0,0 -40.803041,26.93014 '
            '-45.045762,56.53646 z")',
            s
        )
    ...
    def add_upper_body_fill(self) -> UIPieceBuilder:
        ...
        path = self.scale(
            'path("'
            'm 125.06577,137.14983 -10.00132,-0.4546 '
            'c -1.59597,-37.690256 5.037,-29.41556 20.31659,-51.73064 -16.41292,24.40487 -12.20498,36.3396 '
            '-10.31527,52.18524 z")',
            s
        )
    ...
    def add_upper_body_hole(self) -> UIPieceBuilder:
        ...
        path = self.scale(
            'path("'
            'm 133.14627,136.61487 -56.547486,-0.19895 '
            'c 5.190086,-13.96122 13.34471,-30.36957 41.306926,-48.941468 5.71546,0.757575 9.26207,1.031811 '
            '17.47533,-2.509862 -5.39554,16.68229 -7.94588,26.38518 -2.23477,51.65028 z")',
            s
        )
        return self.add(
